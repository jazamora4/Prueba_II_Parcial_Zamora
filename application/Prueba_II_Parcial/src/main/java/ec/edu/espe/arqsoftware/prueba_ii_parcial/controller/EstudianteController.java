...
public class EstudianteController {
    ...
    @GetMapping("matricula/{codCurso}/{correo}")
    public ResponseEntity matricular(@PathVariable("codCurso") String codCurso,@PathVariable("correo") String correo){
        try{
            Matricula matricula = this.estudianteService.matricularEstudiante(codCurso,correo);
